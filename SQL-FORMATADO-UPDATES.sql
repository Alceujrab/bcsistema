-- Execute este SQL no phpMyAdmin - VERSÃO CORRIGIDA E FORMATADA
-- Database: usadosar_lara962

-- 1. Criar a tabela updates
...
-- 2. Inserir dados de exemplo (FORMATADO CORRETAMENTE)
...
SELECT * FROM updates ORDER BY version;
