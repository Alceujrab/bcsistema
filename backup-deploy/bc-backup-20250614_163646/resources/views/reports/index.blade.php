...
<div class="row">
    <div class="col-lg-6 mb-4">
        <div class="card report-card h-100 shadow-sm">
            ...
            <div class="card-footer">
                <a href="{{ route('reports.transactions') }}" class="btn btn-primary w-100">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card report-card h-100 shadow-sm">
            ...
            <div class="card-footer">
                <a href="{{ route('reports.reconciliations') }}" class="btn btn-success w-100">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card report-card h-100 shadow-sm">
            ...
            <div class="card-footer">
                <a href="{{ route('reports.categories') }}" class="btn btn-info w-100">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card report-card h-100 shadow-sm">
            ...
            <div class="card-footer">
                <a href="{{ route('reports.cash-flow') }}" class="btn btn-warning w-100">
