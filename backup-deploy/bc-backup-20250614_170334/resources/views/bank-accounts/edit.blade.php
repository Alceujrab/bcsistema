        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('bank-accounts.update', $bankAccount) }}" method="POST" id="editAccountForm">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="type" id="type" 
                                ...
                                <option value="checking" {{ old('type', $bankAccount->type) == 'checking' ? 'selected' : '' }}>
                                    <i class="fas fa-university me-2"></i>Conta Corrente
                                </option>
                                <option value="savings" {{ old('type', $bankAccount->type) == 'savings' ? 'selected' : '' }}>
                                    <i class="fas fa-piggy-bank me-2"></i>Poupança
                                </option>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="initial_balance" class="form-label fw-bold">
                                <i class="fas fa-money-bill-wave text-success me-2"></i>Saldo Inicial
                            </label>
                            <div class="input-group input-group-lg">
                                ...
                                <input type="number" name="initial_balance" id="initial_balance" 
                                       ...
                                       value="{{ old('initial_balance', $bankAccount->initial_balance) }}" 
                                       step="0.01" 
                                       placeholder="0,00">
                            ...
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
                                Saldo da conta no momento da criação
                            </div>
                        </div>
...
@endpush
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" name="active" id="active" class="form-check-input" 
                                   value="1" {{ old('active', $bankAccount->active) ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('bank-accounts.show', $bankAccount) }}" class="btn btn-secondary">Cancelar</a>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <p><strong>Saldo Atual:</strong> R$ {{ number_format($bankAccount->balance, 2, ',', '.') }}</p>
                <p><strong>Total de Transações:</strong> {{ $bankAccount->transactions()->count() }}</p>
                <p><strong>Criada em:</strong> {{ $bankAccount->created_at->format('d/m/Y H:i') }}</p>
                <p><strong>Última atualização:</strong> {{ $bankAccount->updated_at->format('d/m/Y H:i') }}</p>
                
                <div class="alert alert-warning mt-3">
                    <i class="fas fa-exclamation-triangle me-2"></i>
                    <strong>Atenção:</strong> O saldo não pode ser editado diretamente. Ele é calculado automaticamente com base nas 
