...
function exportDashboard(format) {
    // Funcionalidade de exportação pode ser implementada posteriormente
    if (format === 'pdf') {
        alert('Funcionalidade de exportação PDF será implementada em breve.');
    } else if (format === 'excel') {
        alert('Funcionalidade de exportação Excel será implementada em breve.');
    }
    // Alternativa: redirecionar para página de relatórios
...
function exportDashboard(format) {
    window.open(`{{ route('dashboard') }}?export=${format}`, '_blank');
}
</script>
@endpush