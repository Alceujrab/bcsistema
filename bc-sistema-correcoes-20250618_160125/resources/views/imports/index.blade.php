...
<div class="d-flex justify-content-between align-items-center">
    ...
    <div class="btn-group">
        <a href="{{ route('extract-imports.create') }}" class="btn btn-success">
            <i class="fas fa-cloud-upload-alt me-2"></i> Nova Importação Avançada
        </a>
        <button class="btn btn-outline-success dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown">
            <span class="visually-hidden">Toggle Dropdown</span>
        </button>
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="{{ route('extract-imports.create') }}">
                <i class="fas fa-upload me-2"></i>Upload Multi-formato
            </a></li>
            <li><a class="dropdown-item" href="{{ route('extract-imports.history') }}">
                <i class="fas fa-history me-2"></i>Histórico de importações
            </a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="{{ route('imports.create') }}">
                <i class="fas fa-file-csv me-2"></i>Importação Simples (CSV)
            </a></li>
        </ul>
    </div>
</div>
...
<div class="alert alert-info mt-3">
    ...
    <strong>Novo Sistema Avançado:</strong> Agora com suporte a PDF, Excel e detecção automática de bancos brasileiros!
    <a href="{{ route('extract-imports.create') }}" class="btn btn-outline-primary btn-sm ms-2">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ isset($supportedFormats) ? count($supportedFormats) : 7 }}
                        </div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ isset($imports) ? ($imports instanceof \Illuminate\Pagination\LengthAwarePaginator ? $imports->total() : $imports->count()) : 0 }}
                        </div>
                        <div class="text-xs text-muted mt-1">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <a href="{{ route('imports.template', 'csv') }}" class="btn btn-outline-success btn-sm w-100">
                            <i class="fas fa-file-csv me-2"></i>
                            Template CSV
                        </a>
                    </div>
                    <div class="col-md-4 mb-2">
                        <a href="{{ route('imports.template', 'ofx') }}" class="btn btn-outline-info btn-sm w-100">
                            <i class="fas fa-file-code me-2"></i>
                            Exemplo OFX
                        </a>
                    </div>
                    <div class="col-md-4 mb-2">
                        <a href="{{ route('imports.template', 'qif') }}" class="btn btn-outline-warning btn-sm w-100">
