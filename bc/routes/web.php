...
// API para obter transações disponíveis para conciliação
Route::get('reconciliations/available-transactions', [ReconciliationController::class, 'getAvailableTransactions'])
    ->name('reconciliations.available-transactions');
...
Route::prefix('system/update')->name('system.update.')->middleware('update.security')->group(function() {
    ...
    Route::get('/show/{update}', [UpdateController::class, 'show'])->name('show');
